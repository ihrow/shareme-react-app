...
const Pin = ({pin: {postedBy, image, _id, destination, save}}) => {
  ...
  return (
    <div className="m-2">
      ...
      >
        <img src={urlFor(image).url()} className="rounded-lg w-full" alt="user-post"/>
        {postHovered && (
          <div
          ...
          >
            <div className="flex items-center justify-between">
              ...
              {alreadySaved ? (
                ...
                <button
                  type="button"
                  className="bg-red-500 opacity-70 hover:opacity-100 text-white font-bold px-5 py-1 text-black rounded-3xl hover:shadow-md outline-none"
                  onClick={(e) => {
                    e.stopPropagation();
                    savePin(_id);
                  }}
